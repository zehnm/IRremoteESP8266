...
// Source: https://github.com/espressif/arduino-esp32/blob/idf-release/v5.4/cores/esp32/esp32-hal-gpio.c
...
extern void __attachInterruptFunctionalArg(uint8_t pin, voidFuncPtrArg userFunc, void *arg, int intr_type,
                                           bool functional) {
...
extern void attachInterruptArg(uint8_t pin, voidFuncPtrArg handler, void *arg, int mode)
    __attribute__((weak, alias("__attachInterruptArg")));
